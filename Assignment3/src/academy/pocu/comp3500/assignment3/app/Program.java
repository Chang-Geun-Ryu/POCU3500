...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        final int MAX_MOVE_TIME_MILLISECONDS = 10000000; // Player 가 턴마다 수를 결정하는 데에 주어진 시간
        final long AUTO_PLAY_TURN_DURATION_IN_MILLISECONDS = 10000000; // Autoplay 중 턴마다 일시중지 되는 기간
